    ...
    <form method="POST" action="{{ route('login') ?? '#' }}" id="loginForm">
        ...
        <div class="form-group">
            ...
            <div style="position: relative;">
                <input id="password" class="input-control" type="password" name="password" required autocomplete="current-password" style="padding-right: 2.5rem; width: 100%; box-sizing: border-box;" />
